...
Bem-vindo ao meu repositório de estudos e demonstração técnica. Este projeto foi criado para demonstrar habilidades em diferentes pilares da garantia de qualidade (QA).
...
* Organização em camadas de Clients, Models e Tests.

---

## 🛠️ Tecnologias de Destaque
* **Linguagens:** JavaScript, Java (Selenium).
* **Ferramentas:** Cypress, Selenium, Git, VS Code.
* **Práticas:** Clean Code, DRY (Don't Repeat Yourself), CI/CD (GitHub Actions).

---
*Desenvolvido por Thaís Marchetti Contó*